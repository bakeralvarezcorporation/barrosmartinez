...
export default function HeroSection({pageTitle} : {pageTitle: string}) {
    return(
        <section
            ...
            style={{ backgroundImage: "url('https://bakerandalvarez.site/abogadosasociadosmartinezbarros/wp-content/uploads/sites/3/2025/09/ciudad-panama-scaled.jpg')", backgroundPosition:"center center", backgroundSize:"cover" }} // coloca tu imagen en /public
        >
